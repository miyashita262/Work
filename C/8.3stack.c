...
int main(void){
    ...
    push(&stk, newItem(100, "ABC", 50, 60));
    print(&stk);    printf("==> Num = %d\n\n", getNum(&stk));

    push(&stk, newItem(200, "DEF", 70, 80));
    print(&stk);    printf("==> Num = %d\n\n", getNum(&stk));

    push(&stk, newItem(300, "GHI", 30, 90));
    print(&stk);    printf("==> Num = %d\n\n", getNum(&stk));
    ...
    push(&stk, newItem(400, "JKL", 40, 30));
    print(&stk);    printf("==> Num = %d\n\n", getNum(&stk));
